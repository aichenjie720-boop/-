        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-xl p-5 border border-slate-200 shadow-xs flex flex-col">
            ...
            <div className="h-64 w-full relative">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                <span className="text-[10px] text-slate-400 font-medium">总计支出</span>
          ...
          <div className="lg:col-span-2 bg-white rounded-xl p-5 border border-slate-200 shadow-xs space-y-4">
            <div className="flex items-center justify-between">
              ...
              <span className="text-xs text-slate-500 font-medium">共 {categoryExpenseList.length} 个支出类别</span>
            </div>
                ...
                <div key={cat.id} className="p-3.5 bg-slate-50 rounded-xl border border-slate-200 space-y-2">
                  ...
                  {cat.subList.length > 0 && (
                    <div className="flex flex-wrap gap-1.5 pt-1 text-[11px]">
                      {cat.subList.map((sub) => (
                        <span key={sub.name} className="bg-white border border-slate-200 px-2 py-0.5 rounded-lg text-slate-600 font-medium">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="bg-white rounded-xl p-5 border border-slate-200 shadow-xs flex flex-col">
            ...
            <div className="h-64 w-full relative">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                <span className="text-[10px] text-slate-400 font-medium">总计收入</span>
                ...
                <div key={cat.id} className="p-3.5 bg-slate-50 rounded-xl border border-slate-200 space-y-2">
                  <div className="flex items-center justify-between text-xs sm:text-sm">
                    <div className="flex items-center gap-2.5">
                      ...
                      <span className="font-bold text-slate-800">{cat.name}</span>
                      <span className="text-[11px] text-slate-400 font-medium">({cat.count} 笔)</span>
                    </div>
        ...
        <div className="bg-white rounded-xl p-5 border border-slate-200 shadow-xs space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {memberComparisonList.map((mem) => (
              <div key={mem.id} className="p-4 bg-slate-50 rounded-xl border border-slate-200 space-y-3">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2.5">
                    <div
                  ...
                  <span className="text-xs font-bold font-mono text-indigo-700 bg-indigo-50 px-2 py-0.5 rounded-lg border border-indigo-100/50">
        ...
        <div className="bg-white rounded-xl p-5 border border-slate-200 shadow-xs space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {accountStatsList.map((acc) => (
              <div key={acc.id} className="p-4 bg-slate-50 rounded-xl border border-slate-200 space-y-3">
                <div className="flex items-center justify-between">
